...
internal class D4BuildsToD4CompanionConverterTests : D4BuildsToD4CompanionConverter
{
    ...
    public void AA_OneTimeSetUp()
    {
        ...
        _d4BuildExport = JsonHelpers<D4BuildsExport>.Load("D4Companion/Ressources/D4Builds.Rob's Bone Spear (S3).json") ?? new();
    ...
    {
        JsonHelpers<AffixPreset>.Save("D4Companion/Ressources/d4builds_export.json", _affixPreset, new JsonSerializerOptions() { WriteIndented = true });
        Assert.Pass();
    }
}
