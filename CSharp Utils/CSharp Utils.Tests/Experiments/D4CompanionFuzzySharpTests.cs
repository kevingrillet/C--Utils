...
namespace CSharp_Utils.Tests.Experiments
{
    ...
    internal partial class D4CompanionFuzzySharpTests
    {
        ...
        {
            _affixes = JsonSerializer.Deserialize<List<AffixInfo>>(File.ReadAllText("Ressources/D4Companion/Affixes.enUS.json"))
...
console.log(JSON.stringify(arr, null, 2));
            ...
            */
            ...
            var affixes = JsonSerializer.Deserialize<List<string>>(File.ReadAllText("Ressources/D4Builds.affixes.json"));
