...
public class D4BuildsToD4CompanionConverter
{
    ...
    public D4BuildsToD4CompanionConverter()
    {
        ...
        _affixInfos = JsonSerializer.Deserialize<List<AffixInfo>>(File.ReadAllText("D4Companion/Ressources/D4Companion/Affixes.enUS.json")) ?? [];
        _aspectInfos = JsonSerializer.Deserialize<List<AspectInfo>>(File.ReadAllText("D4Companion/Ressources/D4Companion/Aspects.enUS.json")) ?? [];
        // From: https://github.com/blizzhackers/d4data
        _itemTypes = JsonSerializer.Deserialize<List<D4ItemType>>(File.ReadAllText("D4Companion/Ressources/d4data/ItemTypes.json")) ?? [];
    }
